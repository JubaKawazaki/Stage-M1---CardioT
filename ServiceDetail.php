                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight"><a href="Services">Mes services</a> / Service N°<?php echo $id ?></h1><br>
                            </div>
                            <!-- Actions -->
                        </div>
                        <!-- Nav -->
            ...
            <main class="py-6 bg-surface-secondary">
                <div class="container-fluid">
                    ...
                    <div class="row" style="margin-bottom:2em;background-color:#9ccff9;padding:1em;">
                        <div class="col-3">
                            <label  class="text-dark"for=""><strong>Patient</strong></label>
                            <input type="text" class="form-control" value="<?php echo $Svcs[0]['N'] ." ".$Svcs[0]['P'] ?>" disabled>
                        </div>
                        <div class="col-6"></div>
                        <div class="col-3">
                            <label class="text-dark" for=""><strong>Date</strong></label>
                            <input type="Date" name="Date" value="<?php echo $Svcs[0]['Date'] ?>" disabled class="form-control">
                        </div>
                            </form>
                    </div>
                    <div class="card shadow border-0 mb-7">
                        <div class="table-responsive">
                            <table class="table table-hover table-nowrap">
                                ...
                                <tbody>
                                    <?php foreach ($Svcs as $tmp) : ?>
                                        <form>
                                            <tr>
                                                <td class="text-dark"><strong><?php echo $tmp['Nom'] ?></strong></td>
                                                <td class="text-dark"><strong><?php echo $tmp['Dosage'] ?></strong></td>
                                                <td class="text-dark"><strong><?php echo $tmp['Duree'] ?></strong></td>
                                                <td class="text-dark"><strong><?php echo $tmp['Traitement'] ?></strong></td>
                                            </tr>
                                        </form>
                                    <?php endforeach; ?>
