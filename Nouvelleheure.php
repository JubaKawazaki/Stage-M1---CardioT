...
if (isset($_POST['confirmer'])) {
    ...
    $query = "INSERT INTO `rdv`(`date_patient`) VALUES ('$newdate') ";
        ...
        <div class="h-screen flex-grow-1 overflow-y-lg-auto">
            ...
            <div class="modal-body">
                <form class="form-inline" method="POST">
                    <div>
                        <label><strong>Saisir la date et l'heure qui vous convient :</strong></label>
                        <br>
                        <input type="datetime-Local" name="newdate" class="form-control" id="inlineFormInputGroupUsername2">
                    </div>
                    <br>
